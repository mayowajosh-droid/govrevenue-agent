...
/** Ofcom media and communications datasets — internet usage, broadcast, telecoms. No auth needed. */
export async function fetchOfcomDatasets(): Promise<OfcomDataset[]> {
  try {
    const ac = makeAbort();
    const params = new URLSearchParams({
      q: "ofcom media communications internet broadcasting",
      rows: "20",
