...
.dp-panel:first-child{background:linear-gradient(150deg,rgba(160,82,45,.07) 0%,rgba(180,146,78,.04) 60%,transparent 100%)}
.dp-panel:last-child{background:linear-gradient(210deg,rgba(160,82,45,.07) 0%,rgba(180,146,78,.04) 60%,transparent 100%)}
